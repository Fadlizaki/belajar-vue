  ...
  <!-- <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="https://flowbite.com/" class="flex items-center">
        <span class="self-center text-1xl dark:text-white ml-20" style="font-family: 'League Spartan', sans-serif;">FADLI
          ZAKI</span>
      </a>
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 mr-20" id="navbar-sticky">
        <ul
...
<template>
    <Navbar>
      ...
      <template #default="{isShowMenu}">
        <NavbarCollapse :isShowMenu="isShowMenu" class="mr-20">
          <NavbarLink isActive src="./HelloComponent.vue">Beranda</NavbarLink>
          <NavbarLink src="./HellooComponent.vue">Tentang</NavbarLink>
          <NavbarLink href="./ContackComponent.vue">Kontak</NavbarLink>
        </NavbarCollapse>
      </template>
    </Navbar>
</template>
